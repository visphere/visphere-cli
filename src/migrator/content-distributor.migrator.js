 ...
 *
 *    File name: content-distributor.migrator.js
 *    Last modified: 8/5/23, 3:00 PM
...
async function restartApacheWebServer(stage) {
    ...
    const spinner = promisifyUtils.createAndStartSpinner({ stage, allStages, messages: "Restarting ApacheWeb server" });
    try {
